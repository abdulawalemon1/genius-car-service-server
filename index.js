...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.5pk2q.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
...
app.get('/', (req, res) => {
    res.send('Running Genuis Service Server')
})
